 ...
 */
function getMockExplanation(categoryName: CategoryName, percentage: number): string {
...
export function generateMockAnalysis(_text: string): Category[] {
  ...
  if (import.meta.env.PROD) {
    console.warn("WARNING: `generateMockAnalysis` is being called in a production build. This should be disabled.");
  }

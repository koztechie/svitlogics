  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <strong>secure Svitlogics API gateway.</strong> Your input text is never
        stored.
      </p>
    ),
    plainText:
      "Click the ANALYZE button. The request is sent to the secure Svitlogics API gateway. Your input text is never stored.",
  },
  {
    ...
    content: (
      <>
        <p>
          ...
          of <strong>premium Google Gemini 2.5 models.</strong> This system
          ensures reliability: if a primary model is at capacity, the request
    ...
    plainText:
      "The Svitlogics back-end utilizes a cascade of premium Google Gemini 2.5 models. A custom prompt guides the AI to assess text against five criteria: Manipulative Content, Propagandistic Content, Disinformation, Unbiased Presentation, and Emotional Tone.",
  },
  {
    title: "5. Review the structured report",
    content: (
      <p>
        After a short delay, the system returns a structured report. The report
        contains a percentage-based score and a concise justification for each
        of the five criteria, along with an overall summary.
      </p>
    ),
    plainText:
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        <strong>
          Svitlogics is an auxiliary tool designed to aid your own critical
          thinking.
        </strong>{" "}
        Use the provided data points and analytical justifications to question
        the text's underlying messages, identify potential biases, and form your
        own, more informed conclusions.
      </p>
    ),
    plainText:
      "The results are not a definitive verdict. Svitlogics is an auxiliary tool designed to aid your own critical thinking. Use the data to form your own conclusions.",
  },
];
...
const StepSection: React.FC<{ step: HowToStep }> = ({ step }) => (
  <section aria-labelledby={`step-heading-${step.title.replace(/\s+/g, "-")}`}>
    <h2
      id={`step-heading-${step.title.replace(/\s+/g, "-")}`}
...
const HowItWorksPage: React.FC = () => {
  ...
  const seoDescription =
    "A step-by-step guide on how Svitlogics uses a cascade of premium Google's Gemini 2.5 models to analyze text for manipulation, propaganda, and bias.";
  ...
  const howToJsonLd = {
    ...
    description:
      "A step-by-step guide on how to use Svitlogics to analyze text for manipulation and disinformation using Google Gemini 2.5 AI.",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:title"
          content="How Svitlogics Works | AI Text Analysis Process"
        />

...
const content = {
  ...
  seoDescription:
    "Understand how Svitlogics handles data. This policy details information usage, third-party services like Google Analytics, and our commitment to user privacy.",
    ...
    <div className="space-y-4 font-mono font-normal text-body-main leading-body text-black">
      ...
      {section.list && (
        <ul className="space-y-2 list-disc ml-6">
          {section.list.map(
            (
              item: string // ВИПРАВЛЕНО СИНТАКСИС ТУТ
            ) => (
              <li
